...
#define STRING_CONFIG_H_AUTHOR "(FabX_Pro_MKS Gen, Buvan_Redd)" // Who made the changes.*******************************************************
...
#define EXTRUDER_WATTS (2.5*2.5/0.21) //  P=I^2/R
#define BED_WATTS (17.8*17.8/1.5)      // P=I^2/R
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,405.21,100}  // default steps per unit for Ultimaker 784
#define DEFAULT_MAX_FEEDRATE          {500, 500, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {9000,9000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
//#define SDCARDDETECT 49//SDDETECT
